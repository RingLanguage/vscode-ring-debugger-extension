...
export function activateMockDebug(context: vscode.ExtensionContext, factory?: vscode.DebugAdapterDescriptorFactory) {
	...
	context.subscriptions.push(
		...
		vscode.commands.registerCommand('extension.ring-debugger.debugEditorContents', (resource: vscode.Uri) => {
			let targetResource = resource;
			if (!targetResource && vscode.window.activeTextEditor) {
				targetResource = vscode.window.activeTextEditor.document.uri;
			}
		...
		vscode.commands.registerCommand('extension.ring-debugger.toggleFormatting', (variable) => {
	...
	context.subscriptions.push(vscode.commands.registerCommand('extension.ring-debugger.getProgramName', config => {
